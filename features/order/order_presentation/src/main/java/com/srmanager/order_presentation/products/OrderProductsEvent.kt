...
sealed class OrderProductsEvent {
    ...
    data class OnIncrementEvent(val id: Long, val itemCount: Int) : OrderProductsEvent()
    data class OnDecrementEvent(val id: Long, val itemCount: Int) : OrderProductsEvent()
    ...
    data class OnSetOutletID(val id: String, val customerId: String): OrderProductsEvent()
}