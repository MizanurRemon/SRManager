...
@Composable
fun ProductProductivityScreen(
    onBack: () -> Unit,
    state: ProductProductivityState,
    onEvent: (ProductProductivityEvent) -> Unit,
    ...
    Column(
        modifier = Modifier
            ...
            .clickable {
                onEvent(ProductProductivityEvent.OnMonthSelectionDialogOpen(false))
            }
    ) {
        AppToolbarCompose(
            onClick = { onBack() },
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Box(
                    modifier = Modifier
                        ...
                        .clickable {
                            onEvent(
                                ProductProductivityEvent.OnMonthSelectionDialogOpen(
                                    true
                                )
                            )
                        }
                ...
                OutlinedTextField(
                    ...
                    onValueChange = {
                        onEvent(ProductProductivityEvent.OnSearchEvent(it))
                    },
    ...
    if (state.isMonthSelectionDialogOpen) {
        MonthPicker(
            ...
            cancelClicked = {
                onEvent(ProductProductivityEvent.OnMonthSelectionDialogOpen(isOpened = false))
            },
            confirmButtonCLicked = {
                onEvent(ProductProductivityEvent.OnMonthSelection(it))
            },
...
@Composable
fun MonthlyActivitiesDetails(visitingDetailsList: List<ProductProductivity>) {
...
@Composable
@Preview
fun PreviewProductProductivityScreen() {
