...
import com.srmanager.app.navigations.openAccessibilitySettings
...
import com.srmanager.core.designsystem.theme.ConsentPopUp
...
fun AccessibilityPermissionScreen(
    ...
    Column(
        ...
        ConstraintLayout {
            ...
            Image(
                painter = painterResource(id = com.srmanager.core.designsystem.R.drawable.ic_blue_cross),
                contentDescription = "",
                modifier = Modifier
                    .size(40.dp)
